...
match paket_3011:
    case 1:
        nama_paket_3011 = "Wahana Safari Rimba"
        harga_satuan_3011 = 50000
    case 2:
        nama_paket_3011 = "Wahana Arung Jeram"
        harga_satuan_3011 = 75000
    case 3:
        nama_paket_3011 = "Wahana Motor ATV Ekstrim"
        harga_satuan_3011 = 120000
    case 4:
        nama_paket_3011 = "Wahana Roller Coaster Kilat"
        harga_satuan_3011 = 100000
    case 5:
        nama_paket_3011 = "Wahana All-Access VIP"
...
subtotal_3011 = harga_satuan_3011 * jumlah_tiket_3011
total_diskon_persen_3011 = 0

if subtotal_3011 >= 200000:
    total_diskon_persen_3011 += 10  # Diskon Belanja Besar

if is_member_3011 in ['y', 'ya']:
    total_diskon_persen_3011 += 5  # Diskon Member

if kode_promo_valid_3011 in ['y', 'ya']:
    total_diskon_persen_3011 += 15  # Diskon Voucher Promo

if jumlah_tiket_3011 >= 5:
    total_diskon_persen_3011 += 5  # Diskon Tambahan Rombongan

#==================================================
# ----------EVALUASI KELULUSAN AUDIT---------------
#==================================================

nominal_diskon_3011 = subtotal_3011 * (total_diskon_persen_3011 / 100)
total_bayar_3011 = subtotal_3011 - nominal_diskon_3011

if total_bayar_3011 > 300000:
    catatan_layanan_3011 = "Selamat! Anda berhak mendapatkan Souvenir Gratis."
else:
    catatan_layanan_3011 = "Terima kasih telah berkunjung."

print()
print("--- Rincian Pembayaran ---")
print(f"Subtotal Belanja : Rp {subtotal_3011:,.0f}")
print(f"Total Diskon     : {total_diskon_persen_3011}% (Rp {nominal_diskon_3011:,.0f})")
print(f"Total Bayar      : Rp {total_bayar_3011:,.0f}")
print(f"Catatan Layanan  : {catatan_layanan_3011}")
